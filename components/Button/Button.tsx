...
const styleLoader = (type: string) => {
  switch (type) {
    ...
    case "secondary":
      return `rounded-full bg-white py-2 px-4 font-bold text-primary font-heading uppercase hover:bg-primary hover:text-white transition duration-300 ease-in-out`;
